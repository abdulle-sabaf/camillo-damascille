...
$$ \frac{|AD|}{|DB|} \frac{|BF|}{|FC|} \frac{|CE|}{|EA|} = \frac{m}{l} \frac{n}{m} \frac{l}{n} = 1.$$
...
使用三角函数可以求出垂心$H$的坐标。设$AH$到$BC$的垂足是$H_A$，则$|BH_A| = |AH_A|\cot{B}$、
$|CH_A| = |AH_A|\cot{C}$。也就是说
