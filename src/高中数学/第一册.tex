...
\begin{xt}
    ...
    \indent 2. 证明：\\
    \indent 2.1. 如果数列$\{a_n\}$有上界、数列$\{b_n\}$有下界，那么数列$\{a_n - b_n\}$有上界。\\
    \indent 2.2. 如果数列$\{a_n\}$有上界、数列$\{b_n\}$有下界$b>0$，那么数列$\{\frac{a_n}{b_n}\}$有上界。\\
    \indent 2.3. 如果数列$\{a_n\}$有上界、数列$\{b_n\}$有上界$b<0$，那么数列$\{\frac{a_n}{b_n}\}$有下界。\\
    \indent 3. 给定数列$\{a_n\}$、$\{b_n\}$，如果$a_n \leqslant b_n$总成立，那么两个数列的有界性质有什么联系？
...
就把这个区间称为$f$的\textbf{单调区间}，或者说$f$\textbf{在该区间上单调}。
